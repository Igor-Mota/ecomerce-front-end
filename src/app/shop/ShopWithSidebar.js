      ...
      <div className="row">
        <div className="col-lg-3">
          <div className="axil-shop-sidebar">
            ...
            {/* Gender Filter  */}
            <div
              className={`toggle-list product-categories product-gender ${
                genderToggle ? "active" : ""
              }`}
            >
              <h6
            ...
            {/* Color Filter  */}
            <div
              className={`toggle-list product-color ${
                colorToggle ? "active" : ""
              }`}
            >
              <h6
            ...
            {/* Size Filter  */}
            <div
              className={`toggle-list product-size ${
                sizeToggle ? "active" : ""
              }`}
            >
