              ...
              <div className="row">
                <div className="col-lg-6">
                  <div className="axil-checkout-billing">
                    <h4 className="title mb--40">Confirme o endereço de entrega</h4>
                    <div className="row">
                      <div className="col-lg-12">
                        <div className="form-group shippng-form-toggle">
                          <input
                            {...register("shippingDifferent")}
                        ...
                        <div className="col-lg-12">
                          <div className="form-group">
                            ...
                            {errors.shippingCountry && (
                              <p className="error">Country Name is required.</p>
                            )}
                          </div>
                          <div className="form-group">
                            <label>
                          ...
                          <div className="form-group">
                            ...
                            {errors.shippingPhone && (
                              <p className="error">Please enter 11 digit phone number.</p>
                            )}
                          </div>
                          <div className="form-group">
                            <label>
                            ...
                            <input
                              type="email"
                              {...register("shippingEmail", { required: true })}
                            />
                        ...
                        <tbody>
                          {cartProducts.cartItems.map((items, index) => (
                            <tr className="order-product" key={index}>
                              <td>
                                {items.title}{" "}
                                <span className="quantity">x{items.cartQuantity}</span>
                              </td>
