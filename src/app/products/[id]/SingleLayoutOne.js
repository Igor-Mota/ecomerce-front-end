              ...
              <div className="h-100">
                <div className="position-sticky sticky-top">
                  <div className="row row--10">
                    {singleData.gallery ? (
                      singleData.gallery?.map((image, index) => (
                    ...
                    <div className="inner">
                      ...
                      <div className="product-desc-wrapper pt--80 pt_sm--60">
                        ...
                        {Array.isArray(singleData.description.textDesc) &&
                          singleData.description.textDesc?.map(
                            (data, index) => (
                              <div
                                className={`single-desc ${singleData.description.textDesc[index + 1] ? "mb--30" : ""}`}
                                key={index}
                              >
